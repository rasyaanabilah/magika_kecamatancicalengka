...
export default function SetelanProfil({
  ...
  const handleSaveProfile = (e: React.FormEvent) => {
    ...
    /*
     * Catatan:
     * Password sengaja TIDAK dimasukkan ke updatedUser.
     *
     * Password dikelola oleh Firebase Authentication,
     * bukan Firestore.
     */
  ...
  const handleSaveGroupLink = (e: React.FormEvent) => {
    ...
    setSettingsSuccessAlert(
      'Tautan grup WhatsApp koordinasi berhasil diperbarui.'
    );
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1.5">
            Kelola data diri akun Anda dan perbarui konfigurasi
            tautan WhatsApp grup koordinasi pendaftar.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-white border border-slate-200 rounded-3xl p-6 md:p-8 space-y-6 shadow-xs">
          ...
          <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
            ...
            <h5 className="font-display font-extrabold text-sm text-slate-900">
              Profil Saya
            </h5>
          </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 p-4 bg-slate-50 border border-slate-200/60 rounded-2xl">
              ...
              <div className="space-y-1.5 flex-1 text-center sm:text-left">
                ...
                <p className="text-[10px] text-slate-400">
                  Rekomendasi ukuran persegi, maks 2MB
                  (PNG, JPG, atau JPEG)
                </p>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setGroupLinkInput(e.target.value)
                    }
                    className="w-full px-4 py-2.5 bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 focus:border-blue-500 rounded-xl font-bold transition-all outline-none font-mono text-slate-800"
                  />
                ...
                <p className="text-[10px] text-slate-400 leading-normal">
                  Masukkan link grup WhatsApp koordinasi resmi
                  yang akan dibagikan secara otomatis ke halaman
                  pendaftar yang statusnya telah diubah menjadi{' '}
                  <strong>Lulus</strong> atau{' '}
                  <strong>Sedang Magang</strong>.
                </p>
